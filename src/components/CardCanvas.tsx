  ...
  return (
    ...
    >
      <div className="relative">
        {/* Overlay replacing brightness-40 */}
        <div className="absolute inset-0 rounded-xl bg-black/10 pointer-events-none z-10" />

        <div
          className={`bg-[#1a2f5c] rounded-xl p-4 shadow-lg border border-blue-500/40 ${
            isMobile ? '' : 'py-3'
          }`}
        >
          <div
            className={`text-white ${
              isMobile ? 'w-[336px]' : 'w-[310px]'
            } text-sm select-none`}
          >
