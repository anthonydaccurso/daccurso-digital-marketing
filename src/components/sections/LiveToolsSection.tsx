        ...
        {tools.map((tool) => {
          ...
          return (
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              onClick={() => navigate(tool.path)} // ✅ THIS is the correct spot
              className="flex flex-col lg:flex-row items-center gap-2 lg:gap-3 px-3 lg:px-6 py-3 lg:py-4 rounded-xl transition-all duration-300 text-center lg:text-left bg-[#0d2242] border border-blue-500/20 text-gray-300 hover:bg-blue-500/10 hover:border-blue-500/30"
            >
