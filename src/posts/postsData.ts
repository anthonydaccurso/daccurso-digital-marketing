...
const posts: Post[] = [
  {
    ...
    content: stripFrontmatter(technicalSEO),
  },
  {
    ...
    content: stripFrontmatter(webPerformance),
  },
  {
    ...
    content: stripFrontmatter(contentStrategy),
  },
  {
    ...
    content: stripFrontmatter(responsiveDesign),
  },
];
