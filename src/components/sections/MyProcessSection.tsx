        ...
        <div className="flex flex-col items-center gap-6">
          ...
          {[
            ...
            },
            {
              icon: <Rocket className="w-6 h-6 text-blue-300 mb-2" />,
              title: "Deploy & Refine",
              text: "Deploy on Netlify or Vercel using edge functions and CI/CD. Analyze metrics, refine UX, and evolve features continuously for the best possible client support.",
            },
          ].map((step, i) => (
            <motion.div
              key={i}
