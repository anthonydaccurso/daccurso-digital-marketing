          ...
          {[
            {
              ...
              title: "Design",
              text: "Design directly within WordPress or Figma using Elementor and custom CSS for responsive layouts. Each section is structured for performance and SEO.",
            },
            {
